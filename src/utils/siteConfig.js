module.exports = {
    siteUrl: `https://www.guillermogascon.com`, // Site domain. Do not include a trailing slash!

    postsPerPage: 9, // Number of posts shown on paginated pages (changes this requires sometimes to delete the cache)

    siteTitleMeta: `Guillermo Gascón SEO Manager Blog`, // This allows an alternative site title for meta data for pages.
